...
def publish(request, topic_id, pk=None):
    ...
    return render(request, 'aaold/spirit/comment/publish.html', context)
...
def update(request, pk):
    ...
    return render(request, 'aaold/spirit/comment/update.html', context)
...
def delete(request, pk, remove=True):
    ...
    return render(request, 'aaold/spirit/comment/moderate.html', context)
