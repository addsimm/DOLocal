...
def custom_logout(request, **kwargs):
    ...
    return render(request, 'aaold/spirit/user/auth/logout.html')
...
def register(request, registration_form=RegistrationForm):
    ...
    return render(request, 'aaold/spirit/user/auth/register.html', context)
...
def resend_activation_email(request):
    ...
    return render(request, 'aaold/spirit/user/auth/activation_resend.html', context)
