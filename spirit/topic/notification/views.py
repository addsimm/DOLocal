...
def index_unread(request):
    ...
    return render(request, 'aaold/spirit/topic/notification/index_unread.html', context)
...
def index(request):
    ...
    return render(request, 'aaold/spirit/topic/notification/index.html', context)
